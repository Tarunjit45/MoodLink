...
[![GitHub License](https://img.shields.io/github/license/Tarunjit45/MoodLink?style=flat-square)](LICENSE)
[![CI / Quality Check](https://github.com/Tarunjit45/MoodLink/actions/workflows/ci.yml/badge.svg)](https://github.com/Tarunjit45/MoodLink/actions)
[![Language](https://img.shields.io/badge/Language-JavaScript/TypeScript-blue?style=flat-square)](https://github.com/Tarunjit45/MoodLink)
...
```bash
git clone https://github.com/Tarunjit45/MoodLink.git
cd MoodLink
```
